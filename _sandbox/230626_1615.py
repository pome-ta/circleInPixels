...
class View(ui.View):
  ...
  def set_guide_oval(self, dot_size: float = 2.0, interval: int = 1):
    ...
    for i in range(0, 360, interval):
      ...
      x = (self.radius_length + self.offset_length) + (self.radius_length *
                                                       math.cos(r))
      y = (self.radius_length + self.offset_length) + (self.radius_length *
                                                       math.sin(r))
      ...
      dot.fill()
      print(i)
      print(self.get_position_to_index(x, y), [x, y])
