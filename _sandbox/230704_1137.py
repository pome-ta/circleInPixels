...
class ControlView(ui.View):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.score_text.font = ('Fira Mono', 24)
    self.score_text.alignment = ui.ALIGN_CENTER
...
class MyButtonHandler(object):
  ...
  def button_tapped(self, sender):
    ...
    self.canvas_view.set_needs_display()
    self.r = value
