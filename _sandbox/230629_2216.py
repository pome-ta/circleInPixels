...
class View(ui.View):
  ...
  def draw(self):
    ...
    self.normalize_oval_indexs: list = get_oval_indexs(self.cell_rad)
    self.oval_indexs = list(map(functools.partial(get_normalize_oval_indexs, radius_length=self.cell_rad)))
