...
class View(ui.View):
  ...
  def set_guide_oval(self, dot_size: float = 2.0, interval: int = 1):
    ...
    variance_set = statistics.variance(set_all)
    print(f'{variance_all=}')
    print(f'{variance_set=}')
    median_all = statistics.median(self.index_total_count)
    median_set = statistics.median(set_all)
    print(f'{mean_all=}')
    print(f'{mean_set=}')
    
    fmean_all = statistics.fmean(self.index_total_count)
    fmean_set = statistics.fmean(set_all)
    print(f'{fmean_all=}')
    print(f'{fmean_set=}')
    '''
